...
<div class="subdiv">
	...
	<div class="subdiv">	
		<span style='font-weight:bold;'>Transcripts with GF contains all transcripts with their associated gene family (if existing).</span><br/>	
		<span style='font-weight:bold;'>GF with transcripts contains all the gene families, with their associated transcripts.</span><br/>
		<br/>
		<div style="float:left;width:220px;">
		<?php echo $form->create("",array("action"=>"export_data/".$exp_id,"type"=>"post"));?>
	...
	<div class="subdiv">
		...
		<span style="font-weight:bold;">Transcripts with GO contains transcripts with associated GO terms.</span><br/>
		<span style="font-weight:bold;">GO meta data contains GO terms with counts and associated transcripts.</span><br/>
		<br/>
		<div style="float:left;width:220px;">
		<?php echo $form->create("",array("action"=>"export_data/".$exp_id,"type"=>"post"));?>
		...
		<span style="font-weight:bold;">Transcripts with protein domains contains transcripts with the associated protein domains.</span><br/>
		<span style="font-weight:bold;">Protein domain meta data contains protein domains with counts and associated transcripts.</span><br/>
		<br/>
		<div style="float:left;width:220px;">
		<?php echo $form->create("",array("action"=>"export_data/".$exp_id,"type"=>"post"));?>
